...
#create_clock [ get_ports "CLKI" ]    -name CLKI   -waveform {0   1.8} -period 3.6
#create_clock [ get_ports "CLKI_N" ]  -name CLKI_N -waveform {1.8 3.6} -period 3.6
#create_clock [ get_ports "CLKQ" ]    -name CLKQ   -waveform {0.9 2.7} -period 3.6
#create_clock [ get_ports "CLKQ_N" ]  -name CLKQ_N -waveform {2.7 4.3} -period 3.6
#create_clock [ get_ports "DIN" ]  -name DIN -waveform {0 4} -period 8
